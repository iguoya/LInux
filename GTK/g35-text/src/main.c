 ...
 * 
 * g35-text is free software: you can redistribute it and/or modify it
 * under the terms of the GNU General Public License as published by the
 * Free Software Foundation, either version 3 of the License, or
 * (at your option) any later version.
 * 
 * g35-text is distributed in the hope that it will be useful, but
...
#define TEST
#ifdef TEST
#define UI_FILE "src/g35_text.ui"
#else
#define UI_FILE PACKAGE_DATA_DIR"/ui/g35_text.ui"
#endif
